...
console.log(fenomenler[2].profile);
...
console.log("fenomenler: " , fenomenler);
...
function indekseGoreFenomen(fenomens,index) {
  /*kod*/
  const secilenObje=fenomens[index];
  return `${index}. indekste bulunan fenomen: ${secilenObje.profile}`
}
...
function fenomenEkle(dizi,number,profile,followers,posts,platform) {
  ...
  console.log(fenomenEkle(fenomenler, 6, "Workintech", 100000000, 2022, "Instagram"));
...
function fenomenGonderimSayisi(fenomenleri,profile){
  /*kod*/
  for(let i=0;i<fenomenler.length;i++){
